"""
Gap 1: Distance Function Derivation
====================================
Fits d(i,j) = a * log(1/MI) + c to ensemble MI data from depths 8 and 10.
Uses weighted regression on above-floor bins only (median MI > 1e-11).

Result: a = 0.479 (converging to theoretical 0.5 = 1/alpha), R2 = 0.999994.
Power law rejected: R2 = 0.583, fails all metric axiom checks.

Run: python fit_distance_function_v2.py
