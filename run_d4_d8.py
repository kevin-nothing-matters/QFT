...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("PHASE 1: depth=4 (120 pairs/tree, ~1 min total)")
    print("="*60)
    run_exhaustive(depth=4, n_trees=20)

    print("\n" + "="*60)
    print("PHASE 2: depth=8 (32640 pairs/tree, ~11 min total)")
    print("="*60)
    run_exhaustive(depth=8, n_trees=20)
